...
export const routes: Routes = [
    ...
    {
        path: 'dashboard',
        canActivate: [RedirectIfHasOrgGuard],
        loadComponent: () => import('../app/features/client-dashboard/client-dashboard.component').then(m => m.ClientDashboardComponent),
        children: [
            { path: '', loadComponent: () => import('../app/features/client-dashboard/pages/Dashboard/dashboard.component').then(m => m.DashboardComponent) },
            { path: 'members', loadComponent: () => import('../app/features/client-dashboard/pages/members/members.component').then(m => m.MembersComponent) },
            {
    ...
    { path: 'map', canActivate: [], loadComponent: () => import('../app/car-map/car-map.component').then(m => m.CarMapComponent) },
